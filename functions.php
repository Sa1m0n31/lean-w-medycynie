...
function lean_scripts() {
	wp_enqueue_style( 'lean-style', get_stylesheet_uri() . '?n=14', array(), _S_VERSION );
	wp_enqueue_style('lean-mobile', get_template_directory_uri() . '/mobile.css?n=6', array(), _S_VERSION);
